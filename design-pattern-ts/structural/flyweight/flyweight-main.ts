...
function flyweightMain() {
    ...
    // Demonstrate flyweight reuse
    console.log(`\nFlyweight instances created: ${TimeFormatFactory.getCreatedFlyweightsCount()}`);
    console.log("Flyweight keys:", TimeFormatFactory.getCreatedFlyweightKeys());
    ...
    console.log(`\nTotal flyweight instances: ${TimeFormatFactory.getCreatedFlyweightsCount()}`);
